...
(function () {
  ...
  var EL = {
    ...
    'hero.sub': 'Σου βγάζουμε από πάνω τις επαναλαμβανόμενες ερωτήσεις, τα ακυρωμένα ραντεβού και τα τηλέφωνα «πού είναι η παραγγελία μου;» — μ’ έναν Greek-first βοηθό που απαντά 24/7 και κλείνει ραντεβού, ελέγχει παραγγελίες και ενημερώνει μόνος του το CRM σου. EU-hosted, χτισμένο πάνω στο Claude, έτοιμο σε μέρες.',
    'hero.cta1': 'Μίλα στο ζωντανό bot →',
    'hero.cta2': 'Δες πακέτα & τιμές',
    'hero.meta1': '<b>1–3 μέρες</b> για ένα FAQ widget',
    'hero.meta2': '<b>EU servers</b> · GDPR καλυμμένο',
    ...
    'build.c1.p': 'Το widget που απαντά σε ωράρια, τιμές, «πού είστε;» — και τα πιο έξυπνα που διαβάζουν όλη τη βάση γνώσης σου πριν απαντήσουν.',
    ...
    'build.c2.p': 'Όχι απλώς μιλούν — δρουν. Κλείνουν το ραντεβού, ελέγχουν την παραγγελία, καταχωρούν την επιστροφή, σπρώχνουν το lead στο CRM σου. Tool-calling με audit log σε κάθε ενέργεια.',
    ...
    'demo.h2': 'Αυτό είναι ένα πραγματικό bot επιπέδου FAQ. Ρώτα το κάτι.',
    'demo.lede': 'Το widget παρακάτω το φιλοξενούμε εμείς — το ίδιο stack που θα σου παραδίδαμε, ενσωματωμένο μ’ ένα μόνο script tag. Είναι build επιπέδου Tier-1 FAQ, οπότε απαντά από ένα σταθερό σύνολο γνώσης και δεν κρατά credentials. Ζόρισέ το: ρώτα για ωράρια, τιμές, για το τι δεν μπορεί να κάνει. <a class="lx-link" href="https://chat-bot-henna-mu.vercel.app/" target="_blank" rel="noopener">Άνοιξέ το σε πλήρη οθόνη ↗</a>',
    'demo.loading': 'ξυπνάει το demo bot…',

    'proof.s1': 'Πάντα ενεργό — ακόμα κι όταν έχεις κλείσει',
    'proof.b2': '1–3 μέρες',
    'proof.s2': 'Από το πρώτο call σε ζωντανό FAQ widget',
    'proof.s3': 'Hetzner, Γερμανία · GDPR εξ ορισμού',
    'proof.s4': 'Production RAG retrieval που χτίσαμε & τρέχουμε',
    ...
    't3.p1.set': 'setup €700',
    't3.range': '€190–250/μήνα ανάλογα με τον όγκο συνομιλιών και την πολυπλοκότητα των σεναρίων.',
    't3.fit': '<b>Ιδανικό για:</b> υπηρεσίες με leads — μεσιτικά, ασφάλειες, B2B.',
    't3.cta': 'Ξεκίνα να μαζεύεις leads →',
    ...
    'why.h2': 'Φτιαγμένο με τον βαρετό-αλλά-σημαντικό τρόπο',
    'why.i1.h4': 'EU-hosted, GDPR εξ ορισμού',
    'why.i1.p': 'Servers Hetzner στη Γερμανία. Οι συνομιλίες των πελατών σου δεν κάνουν ταξίδι πέρα από τον Ατλαντικό χωρίς λόγο.',
    'why.i2.h4': 'Greek-first, όχι ελληνικά εκ των υστέρων',
    'why.i2.p': 'Προεπιλέγουμε το Claude γιατί χειρίζεται καλά το ελληνικό ύφος και το RAG. Φθηνότερα open μοντέλα μόνο όπου το δικαιολογεί ο όγκος.',
    'why.i3.h4': 'Έχουμε ξαναφτιάξει RAG',
    'why.i3.p': 'Το retrieval stack εδώ δεν είναι η πρώτη μας φορά — φτιάξαμε ένα για τη Mnema. Τα embeddings και το pgvector τρέχουν στη δική μας πλευρά, όχι σε black box.',
    ...
    'why.i5.h4': 'Δουλεύει με ό,τι έχεις',
    'why.i5.p': 'Soft1, Entersoft, Epsilon, Megasoft στο ERP· Cal.com ή Google για ημερολόγια. Δεν έχεις σύστημα; Στήνουμε ένα.',
    ...
    'faq.a4': 'Ναι — κάθε επίπεδο είναι δίγλωσσο EL/EN εξ ορισμού και το περιεχόμενο γράφεται στα ελληνικά. Χτίζουμε πάνω στο Claude εξ ορισμού γιατί χειρίζεται καλύτερα το ελληνικό ύφος και τις λεπτές αποχρώσεις, και κατεβαίνουμε σε πιο οικονομικό μοντέλο μόνο όπου το δικαιολογεί ο μεγάλος όγκος συνομιλιών.',
  ...
  var META = {
    en: {
      ...
      desc: 'LógosAI designs conversational chatbots, action-taking AI agents, and the websites they live on. Greek-first, EU-hosted, Claude-powered. Live demo on the page.'
    },
    el: {
      title: 'LógosAI — Chatbots, AI Agents & ιστοσελίδες για ελληνικές επιχειρήσεις',
      desc: 'Η LógosAI σχεδιάζει συνομιλιακά chatbots, AI agents που εκτελούν ενέργειες, και τις ιστοσελίδες όπου ζουν. Greek-first, EU-hosted, χτισμένα πάνω στο Claude. Ζωντανό demo στη σελίδα.'
    }
  };
